...
| ![C0-microSD on breadboard](/docs/assets/images/ortho-renders/breakout-board/signaloid-external-illustration-C0-microSD-populating-a-breadboard-using-a-microSD-breakout-board-withCR.png) | ![C0-microSD on microcontroller](/docs/assets/images/ortho-renders/signaloid-external-illustration-C0-microSD-connected-to-an-existing-microcontroller-platform-withCR.png) |
|:--:| :--:|
